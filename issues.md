...
* ~~Split card versions in the buy list — the buylist currently groups all copies of a card by name regardless of set; this would split them by specific set/version so you can track which printing you need~~ ✓ (card number now shown in Set column)