# Pokemon TCG Deck Archive — User Testing
...
| 17 | Inspect a proxy card | Purple sleeve styling | |
| 18 | Inspect a missing card | Red sleeve styling | |
| 19 | Inspect an ordered card | Blue sleeve styling | |
...
| 70 | Try creating with no name | Disabled or validation error | |

### 6.2 Deck list
| # | Step | Expected | Result |
|---|------|----------|--------|
| 71 | Check deck row | Shows name, era badge, energy, format, real/proxy/missing counts | |
